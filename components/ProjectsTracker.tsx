...
export default function ProjectsTracker({ projects, onUpdate }: ProjectsTrackerProps) {
  ...
  const [editStatus, setEditStatus] = useState<'In Progress' | 'Active' | 'Planning'>(
    'In Progress'
  );
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                <div>
                  ...
                  <select
                    ...
                    value={newStatus}
                    onChange={(e) =>
                      setNewStatus(e.target.value as 'In Progress' | 'Active' | 'Planning')
                    }
                  >
            ...
            >
              ...
              <div>
                ...
                <select
                  ...
                  value={editStatus}
                  onChange={(e) =>
                    setEditStatus(e.target.value as 'In Progress' | 'Active' | 'Planning')
                  }
                >
                  <option value="In Progress">In Progress</option>
                  <option value="Active">Active</option>
