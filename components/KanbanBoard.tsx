          ...
          {columnTasks.length === 0 ? (
            ...
            columnTasks.map((task) => {
              ...
              if (task.priority === 'high')
                priorityBadge = <span className="badge badge-rose">High</span>;
              else if (task.priority === 'med')
                priorityBadge = <span className="badge badge-amber">Med</span>;
        ...
        <div className="card-title-group">
          ...
          <div>
            ...
            <p className="card-subtitle">
              {tasks.length} total tasks &bull; {doneTasks.length} completed
            </p>
          </div>
        </div>
      ...
      <div className="card-body">
        <div className="kanban-board">
          {renderColumn(
            ...
            'todo',
            todoTasks,
            <CircleDashed size={13} style={{ color: 'var(--accent-amber)' }} />
          )}
          {renderColumn(
            'In Progress',
            'in-progress',
