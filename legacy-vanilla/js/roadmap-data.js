/**
 * 100 Engineering Capabilities Roadmap Data
 * Architected for DevDash by Sagar Murkute
 */
...
class RoadmapRenderer {
  constructor() {
    this.container = document.getElementById('roadmap-categories-container');
  ...
  render() {
    ...
    this.container.innerHTML = ROADMAP_DATA.map((cat, catIdx) => {
    ...
    if (this.countBadge) {
      this.countBadge.textContent = `${totalVisible} / 100`;
    }
